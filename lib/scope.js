...
function resolveScope(scope) {
  ...
  if (s === 'user') {
    ...
    return {
      ...
      specifyDir: path.join(root, 'specify'),
...
module.exports = { resolveScope, AGENT_NAMES, COMMAND_NAMES, MEMORY_SUBDIRS, SPECIFY_TEMPLATE_NAMES, TEAM_SOFTWARE_MARKER };

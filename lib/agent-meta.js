...
module.exports = [
  ...
  {
    name: 'bug-hunter',
    tagline: 'Caza bugs proactivamente — static + tooling (tests, lint, typecheck, build) + cross-ref',
    when: 'No sabes qué está roto pero la app tiene cosas raras. Te encuentra bugs sin que los señales.',
  },
  {
    name: 'exploratory-tester',
    tagline: 'Simula viajes de usuario por el código — dead-ends, flows rotos, estados imposibles',
    when: 'Quieres saber qué le pasa al usuario en cada flow. Complementa bug-hunter con perspectiva UX.',
  },
];
